...
const PATRONEADO: Record<string, PatternResult> = {
  ...
  "D-E": { title: "El Laberinto Renovado", body: "Justo cuando una dirección toma forma y podría consolidarse, una circunstancia externa la interrumpe o complica, renovando la necesidad de seguir buscando. El laberinto tiene salidas que se cierran antes de ser cruzadas." },
...
const FORTALEZA: Record<string, PatternResult> = {
  "A-A": { title: "La Inteligencia Estratégica al Servicio del Merecimiento", body: "Tu capacidad de análisis y pensamiento estratégico es un recurso real y probado. La transformación que buscas — sentirte genuinamente merecedor de resultados grandes — tiene en esa inteligencia su mejor aliada. El siguiente paso es dirigirla hacia adentro con la misma precisión que la diriges hacia afuera." },
  ...
  "B-E": { title: "La Resistencia en la Incertidumbre", body: "Tu capacidad de persistir en lo difícil es un recurso real y verificado. La claridad y el coraje que buscas no vienen de condiciones perfectas — vienen de la capacidad de avanzar en la incertidumbre. Eso ya lo has demostrado que puedes hacer." },
  ...
  "C-E": { title: "La Red como Espejo de la Dirección", body: "Las personas clave con quienes conectas suelen tener claridad sobre lo que ven en ti — a veces más de lo que tú mismo ves. Esa perspectiva externa puede ser el recurso que te ayude a encontrar y comprometerte con la dirección que buscas desde adentro." },
